...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self,page: Page, identifier: str):
        ...
        self.image_upload__info_title = page.get_by_test_id(f'{identifier}-image-upload-widget-info-title-text')
    ...
    def check_visible(self, is_image_uploaded: bool = False):
        ...
        expect(self.image_upload__info_title).to_be_visible()
        expect(self.image_upload__info_title).to_have_text(
